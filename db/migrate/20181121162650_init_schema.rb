...
class InitSchema < ActiveRecord::Migration[6.0]
  def up
    ...
    create_table 'announcements', id: :serial do |t|
      t.string 'title'
    ...
    create_table 'event_users', id: :serial do |t|
      t.integer 'event_id'
      t.integer 'user_id'
      t.datetime 'created_at', null: false
      t.datetime 'updated_at', null: false
      ...
      t.string 'remark'
      t.index %w[event_id user_id], name: 'index_event_users_on_event_id_and_user_id', unique: true
    ...
    create_table 'messengers' do |t|
      ...
      t.index %w[provider uid], name: 'index_messengers_on_provider_and_uid', unique: true
      t.index ['user_id'], name: 'index_messengers_on_user_id'
    end
    create_table 'oauths', id: :serial do |t|
      t.integer 'user_id'
      t.string 'provider'
      t.string 'uid'
      t.datetime 'created_at', null: false
      t.datetime 'updated_at', null: false
      t.text 'token'
      t.index %w[provider uid], name: 'index_oauths_on_provider_and_uid', unique: true
    ...
    create_table 'service_schedules', id: :serial do |t|
    ...
    create_table 'service_team_users', id: :serial do |t|
      t.integer 'user_id'
      t.integer 'role_id'
      t.integer 'service_team_id'
      t.datetime 'created_at', null: false
    ...
    create_table 'service_teams', id: :serial do |t|
      t.integer 'user_id'
      t.string 'name'
      t.datetime 'created_at', null: false
      t.datetime 'updated_at', null: false
